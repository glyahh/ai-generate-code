...
public class AiCodeGeneratorFacade {
    ...
    public File generateAndSaveCode(String userMessage, CodeGenTypeEnum codeGenTypeEnum) {
        ...
        return switch (codeGenTypeEnum) {
            case HTML -> {
                ...
                yield codeFileSaverExecutor.execute(codeGenTypeEnum, result);
            }
            case MULTI_FILE -> {
     ...
     * @return
     */
    private Flux<String> processCodeStream(CodeGenTypeEnum codeGenTypeEnum, Flux<String> result) {
        ...
        return result.doOnNext(CodeBuilder::append)
                .doOnComplete(() -> {
                    try {
                        ...
                        File file = codeFileSaverExecutor.execute(codeGenTypeEnum, executeResult);
    ...
    private Flux<String> generateAndSaveMultiFileCodeStream(String userMessage) {
        ...
        return processCodeStream(CodeGenTypeEnum.MULTI_FILE, result);
    }
    ...
    private Flux<String> generateAndSaveHtmlCodeStream(String userMessage) {
        ...
        return processCodeStream(CodeGenTypeEnum.HTML, result);
    }
}
